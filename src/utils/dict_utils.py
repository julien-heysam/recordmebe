...
class DictionaryUtils:
    ...
    def flatten_dict(d: Dict[str, Any], parent_key: str = "", sep: str = "_") -> Dict[str, Any]:
        ...
        for k, v in d.items():
            ...
            if isinstance(v, dict):
                items.extend(DictionaryUtils.flatten_dict(v, new_key, sep=sep).items())
            else:
    ...
    def replace_values(
        ...
        for k, v in d.items():
            if isinstance(v, dict):
                result[k] = DictionaryUtils.replace_values(v, value_to_replace, default_value, recursive=True)
            else:
